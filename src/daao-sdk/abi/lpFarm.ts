...
export const LP_FARM_ABI: Abi = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_maxIncentiveStartLeadTime', type: 'uint256' },
      { internalType: 'uint256', name: '_maxIncentiveDuration', type: 'uint256' },
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'contract IERC20Minimal', name: 'rewardToken', type: 'address' },
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'uint256', name: 'reward', type: 'uint256' },
      { internalType: 'uint160', name: 'secondsInsideX128', type: 'uint160' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint160', name: 'totalSecondsClaimedX128', type: 'uint160' },
      { internalType: 'uint96', name: 'numberOfStakes', type: 'uint96' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'contract IERC20Minimal', name: '', type: 'address' },
      { internalType: 'address', name: '', type: 'address' },
    ],
    name: 'rewards',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
  ...
  },
  {
    ...
    name: 'stakes',
    outputs: [
      { internalType: 'uint160', name: 'secondsPerLiquidityInsideInitialX128', type: 'uint160' },
