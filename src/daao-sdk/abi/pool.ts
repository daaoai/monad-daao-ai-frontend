...
export const POOL_ABI: Abi = [
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'amountToken1', type: 'uint256' }],
    name: 'addRewards',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [],
    name: 'factory',
    outputs: [{ internalType: 'contract IDAOFarmFactory', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'pendingRewards',
    outputs: [{ internalType: 'uint256', name: 'pending1', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'endTime_', type: 'uint256' }],
    name: 'setDateSettings',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'rewardDebtToken1', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
